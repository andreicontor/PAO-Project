...
public class TransactionDatabase {
    ...
    public void update(Transaction newTransaction){
        try{
            ...
            preparedStmt.setString(4, (new SimpleDateFormat("yyyy-MM-dd h:m:s")).format(newTransaction.getTransactionDate()));
    ...
    public void create(Transaction transaction){
        try{
            ...
            preparedStmt.setString(4, transaction.getDetails());
            preparedStmt.setString(5, (new SimpleDateFormat("yyyy-MM-dd h:m:s")).format(transaction.getTransactionDate()));
    ...
    public void delete(Transaction transaction){
        try{
            ...
            preparedStmt.setString(1, transaction.getFromIBAN());
            preparedStmt.setString(2, transaction.getToIBAN());
            preparedStmt.setString(3, (new SimpleDateFormat("yyyy-MM-dd h:m:s")).format(transaction.getTransactionDate()));
            preparedStmt.execute();
            preparedStmt.close();
        }catch (Exception e){
            System.out.println(e.toString());
